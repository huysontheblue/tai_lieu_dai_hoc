...
Public MustInherit Class NPOIExcle
    ...
    ''' <param name="Ay">数组表头标题集合</param>
    ''' <param name="FileName">xls文件名称</param>
    ''' <remarks></remarks>
    Public Shared Sub DataTableExportToExcle(ByVal dt As DataTable, ByVal Ay() As String, ByVal FileName As String)
        ...
        For i As Integer = 0 To dt.Columns.Count - 1
            ...
            If Not Ay Is Nothing Then
                cell.SetCellValue(Ay(i))
            Else
