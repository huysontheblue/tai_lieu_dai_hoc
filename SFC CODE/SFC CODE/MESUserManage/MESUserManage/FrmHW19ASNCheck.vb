...
Public Class FrmHW19ASNCheck
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub txtOld19Code_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtOld19Code.KeyPress
        If e.KeyChar = Chr(13) Then
            If String.IsNullOrEmpty(Me.txtOld19Code.Text) Then
                MessageUtils.ShowError(" 旧19条码不能为空 ")
                Me.txtOld19Code.Focus()
                Exit Sub
            Else
    ...
    Private Sub txtNewASNQRCode_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtNewASNQRCode.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            Else
             ...
             "exec m_CheckHW19ASNCode  '" + Me.txtOld19Code.Text.Trim + "','" + Me.txtNewASNQRCode.Text.Trim + "',@Msg out,@ReturnValue out" & vbCrLf &
