    ...
    Private Sub getPartStyle()
        ...
        Try
            For Each dr1 As DataRow In Dt1.Rows
                ...
                SqlStr = " DECLARE @SnStyle1 varchar(150),@SnStyle2 varchar(70),@Gflen varchar(2) set @SnStyle1='' set @SnStyle2=''  set @Gflen='' " &
                         " EXECUTE m_StyleMultiShow_AssembleSta '" & dr1("partid").ToString & "','" & dr1("coderuleid").ToString & "','" & dr1("PackingLevel").ToString & "','" & TimeStyleSet & "',@SnStyle1 output ,@SnStyle2 output,@Gflen output,'" & Me.mtxtMOid.Text.Trim & "' " &
