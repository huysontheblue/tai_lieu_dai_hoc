...
Public Class FrmQueryProductionRecord
    ...
    Private Sub ToolReflsh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolReflsh.Click
        ...
        Try
            ...
            End If
            strSQL = "exec GetProductionRecords '" & StartDT & "','" & EndDT & "','" & PartID & "','" & Moid & "','" & StationID & "'" ','" & LineID & "','" & PPID & "'"
    ...
    Private Sub ShowNGDetail(ByVal strPartid As String, ByVal strStation As String)
        ...
        Dim sqlstr As String = " EXEC m_SearchNgDataReportTotal_p '" & moid & "','" & strPartid & "','','','','','" &
