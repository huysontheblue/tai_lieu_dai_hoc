...
Public Class FrmWarehousingQuery
...
#Region "加载事件"
    ...
    Private Sub FrmWarehousingQuery_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
...
#Region "工具事件"
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            End If
            Dim warehouseingMaster As New FrmWarehouseingMaster(strInvoiceDefinitionsTypeName, "")
    ...
    Private Sub btnPrinter_Click(sender As Object, e As EventArgs) Handles btnPrinter.Click
        ...
        Try
            ...
            Dim cell As New PdfPCell(New Phrase("入库单", fontHeader))
            cell.Colspan = 6
            ...
            For i As Int16 = 0 To Me.dgvInvoiceTransactionItem.RowCount - 1
                ...
                WarehouseLocationId = IIf(IsDBNull(Me.dgvInvoiceTransactionItem.Rows(i).Cells("WarehouseLocationId").Value), "", Me.dgvInvoiceTransactionItem.Rows(i).Cells("WarehouseLocationId").Value)
...
#Region "函数"
    ...
    Private Sub GetTransactionItem(ByVal InvoiceTransactionId As String)
        ...
        Try
            ...
            Do While DReader.Read()
                Me.dgvInvoiceTransactionItem.Rows.Add(DReader.Item("RowNum").ToString, DReader.Item("MaterialNO").ToString, DReader.Item("Description").ToString, DReader.Item("Specification").ToString, DReader.Item("Uint").ToString, DReader.Item("WarehouseLocationId").ToString, DReader.Item("Quantity").ToString, DReader.Item("UnitPrice").ToString, DReader.Item("TotalAmount").ToString, DReader.Item("OrderNumber").ToString, DReader.Item("Remark").ToString)
            Loop
