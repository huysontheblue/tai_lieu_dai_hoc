...
Public Class FrmTestDataRules
    ...
    Private Sub SearchRecord(ByVal Sqlstring As String)
        Dim SqlSearch As String = String.Format("select TestTypeID,TestTypeName,DocumentType,SelectSql,SaveTableName,Usey,MaxTestCount,KeyFileld,KeyIndex,StationSEQ,ProductGroup,CheckFunction,CompleteProcess,Userid,Intime from " & cbbdatabase.Text.Trim & ".[MESDataCenter].dbo.m_testtype_t where 1=1 {0}", Sqlstring)
    ...
    Private Sub toolEdit_Click(sender As Object, e As EventArgs) Handles toolEdit.Click
        ...
        txttestcount.Text = DbOperateUtils.DBNullToStr(DgList.CurrentRow.Cells("MaxTestCount").Value)
        opflag = 2
        SetControlStutas(2)
    End Sub
    '删除
    ...
    Private Sub toolSave_Click(sender As Object, e As EventArgs) Handles toolSave.Click
        ...
        ElseIf opflag = 2 Then
            ...
            SqlStr.AppendFormat(" ,MaxTestCount = '{0}'", txttestcount.Text.Trim)
