...
Namespace MesDataServices
    ...
    Partial Public Class MESDataServices
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.SFCSUpdate.My.MySettings.Default.SFCSUpdate_MesDataServices_MESDataServices
        ...
        '''<remarks/>
        Public Overloads Sub ExecECNBomUpdateAsync(ByVal FactoryId As String, ByVal profitcenter As String, ByVal dtBom As System.Data.DataTable, ByVal ECNID As String)
            Me.ExecECNBomUpdateAsync(FactoryId, profitcenter, dtBom, ECNID, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ExecECNBomUpdateAsync(ByVal FactoryId As String, ByVal profitcenter As String, ByVal dtBom As System.Data.DataTable, ByVal ECNID As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ExecECNBomUpdate", New Object() {FactoryId, profitcenter, dtBom, ECNID}, Me.ExecECNBomUpdateOperationCompleted, userState)
        End Sub
