...
Public Class FrmWarehouseLoactionQuery

#Region "变量声明"

    Dim _txtWarehouseLocationContral As MaskedTextBoxAdv
...
#Region "构造函数"
    ...
    Public Sub New(ByVal txtWarehouseLoactionContral As MaskedTextBoxAdv)
        MyBase.New()
        '该调用是 Windows 窗体设计器所必需的。
        InitializeComponent()
    ...
    Private Sub btnDetermine_Click(sender As Object, e As EventArgs) Handles btnDetermine.Click
        Try
            If Me.dgvQuery.Rows.Count = 0 OrElse Me.dgvQuery.CurrentRow Is Nothing Then
                ...
                Exit Sub
            End If
            _txtWarehouseLocationContral.Text = Me.dgvQuery.Rows(Me.dgvQuery.CurrentRow.Index).Cells("WarehouseLoactionCode").Value.ToString()
            Me.Close()
        Catch ex As Exception
