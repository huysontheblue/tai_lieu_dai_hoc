...
Public Class FrmQueryProductionUPH
    Private PPID As String = ""
    Private ObjDB As New MainFrame.SysDataHandle.SysDataBaseClassReport()
    Private rs As SqlDataReader
    Private Sub FrmQueryProductionUPH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ToolReflsh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolReflsh.Click
        ...
        Try
            ...
            End If
            strSQL = "exec GetProductionUPH '" & StartDT & "','" & EndDT & "','" & PartID & "','" & Moid & "','" & StationID & "'" ','" & LineID & "','" & PPID & "'"
