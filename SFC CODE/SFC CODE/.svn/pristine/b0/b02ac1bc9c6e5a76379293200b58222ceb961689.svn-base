...
Public Class FrmReportChar
    ...
    Private _Param As Object = New Object
    Public Property PubParam() As Object
        Get
            Return _Param
        End Get
    ...
    Private Sub FrmReportChar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If SummaryDs.Tables.Count > 1 Then
    ...
    Private Sub CreateChar()
        ...
        If ReportSQL <> "" Then
            SummaryDs = Conn.GetDataSet(ReportSQL, PubParam)
        Else
