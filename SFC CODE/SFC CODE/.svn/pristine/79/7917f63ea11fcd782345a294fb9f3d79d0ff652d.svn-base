...
#Region "事件"
    ...
    Private Sub toolEdit_Click(sender As Object, e As EventArgs) Handles toolEdit.Click
        ...
        txtYield.Text = Me.dgvParttype.CurrentRow.Cells("YieldLine").Value.ToString
    ...
    Private Sub SavaData()
        Try
            ...
            Else
                ...
                o_strSql.Append(" UPDATE m_partinput_t SET partid='" & txtPartId.Text & "',Model='" & cbtype.SelectedValue.ToString & "',userid='" & UserID & "',YieldLine = '" & txtYield.Text & "',usey = '" & IIf(chkUsey.Checked = True, "Y", "N") & "', intime=GETDATE() WHERE  partid='" & partid & "' and  Model='" & obacode & "'")
