...
Public Class FrmAssetLend
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            For Each strID As String In Me.lblID.Text.Trim.Split(",")
                sql.Append(" Update  m_Asset_t SET CStatus = N'使用中', Status = '1', ")
                sql.Append(" KeeperID = N'" & Me.txtKeeperID.Text.Trim & "', KeeperName =  N'" & EquManageCommon.GetUserName_All(Me.txtKeeperID.Text.Trim) & "',")
                ' Me.txtStorage.Text.Trim.Replace("'", "''") & "
                sql.Append(" TempLocation =N'" & strStorage & "', ")
            ...
            MessageUtils.ShowInformation("借出成功")
            Me.Close()

        Catch ex As Exception
            ' Throw ex
            SysMessageClass.WriteErrLog(ex, "EquipmentManagement.FrmAssetLend", "btnSave_Click", "WIP")
        End Try
    ...
    Private Function CheckInput() As Boolean
        ...
        If IsNothing(Me.cboRequestLine.SelectedValue) OrElse String.IsNullOrEmpty(Me.cboRequestLine.SelectedValue.ToString) Then
            If String.IsNullOrEmpty(Me.txtStorage.Text) Then
