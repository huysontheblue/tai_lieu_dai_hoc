...
#Region "变量声明"
    ...
    Public _txtLineIdContral As String

    Public _DialogDeptID As String
...
#Region "构造函数"
    ...
    Public Sub New(ByVal txtLineIdContral As String)
        MyBase.New()
        '该调用是 Windows 窗体设计器所必需的。
        InitializeComponent()
    ...
    Private Sub btnDetermine_Click(sender As Object, e As EventArgs) Handles btnDetermine.Click
        Try
            If Me.dgvQuery.Rows.Count = 0 OrElse Me.dgvQuery.CurrentRow Is Nothing Then
                ...
                Exit Sub
            End If
            _txtLineIdContral = Me.dgvQuery.Rows(Me.dgvQuery.CurrentRow.Index).Cells("LineId").Value.ToString()
            _DialogDeptID = Me.dgvQuery.Rows(Me.dgvQuery.CurrentRow.Index).Cells("DeptId").Value.ToString()
