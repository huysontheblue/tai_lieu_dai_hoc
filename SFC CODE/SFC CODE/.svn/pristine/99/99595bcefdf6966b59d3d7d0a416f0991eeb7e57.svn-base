...
#Region "Members"
    ...
    '''' lrq   2007/01/10 ''''
    Dim m_PartPackQty As String    ''箱裝數量 歐翔烽 2007 01 29
    Dim m_PrintPort As String
    Dim m_PackNumber As String   ''外箱編號
    Dim m_strPackItem As String  'cq 20160127
    ...
    'Dim m_MoTotalCarton As Integer
    ...
    Dim m_IsOnlineGenCartonID2 As Boolean ''是否在线生成外箱号, 第二层
    Dim m_IsOnlineGenPalletID As Boolean ''是否在线生成大外箱号, cq 20160126
    Dim m_PrtPalletCheck As Boolean ''是否在线打印栈板信息 柯华松  2014/05/14
    Dim m_RepeatStyle As String ''是否校验产品条码或固定码 柯华松  2016/09/27
    Dim m_RepeatPara As String ''校验条码或固定码参数次序 柯华松  2016/09/27
    Dim m_CartonRepeatStyle As String ''是否校验箱条码或固定码 cq  2016/09/27
    Dim m_CartonRepeatPara As String ''校验箱条码或固定码参数次序 cq  2016/09/27
    Dim m_BigCartonRepeatStyle As String ''是否校验大外箱条码或固定码 cq  20180828（三层)
    Dim m_BigCartonRepeatPara As String ''校验箱条码或固定码参数次序 cq
    Dim m_IsLinePrintFullCode As String '在是否在线打印整箱条码(标签数) 田玉琳 2016/04/26
    Dim m_LabelNum As String '在是否在线打印整箱条码(标签数) 田玉琳 2016/04/26
    Dim m_IsLineWeight As String '在是否在线打印整箱条码称重 田玉琳 2016/05/04

    Dim m_IsPpidLineWeight As String '在线产品称重 hgd 2018-06-06
    Dim m_IsPrtSelf As String    '是否自制条码 田玉琳 2016/09/05
    Dim m_IsScanN As String      '是否扫描多次 田玉琳 2017/05/10
    ...
    Dim m_TTPackQty As Integer 'TT包装数量
    Dim m_UpLimitWeight As String '外箱重量上限
    Dim m_LowLimitWeight As String '外箱重量下限

    Dim m_PpidUpLimitWeight As String '产品重量上限
    Dim m_PpidLowLimitWeight As String '产品重量下限
    Dim m_IsNotCaseSensitive As String '不区分大小写
    Dim m_IsEquipMoSet As String '是否已經設置工治具
    Dim m_ScanNumber As String '组合扫码次数
#End Region
...
#Region "Properties"
    ...
    Public Property vRepeatStyle() As String
    ...
    Public Property vRepeatPara() As String
    ...
    Public Property vCartonRepeatStyle() As String
        Get
            Return m_CartonRepeatStyle
        End Get
        Set(ByVal Value As String)
            m_CartonRepeatStyle = Value
        End Set
    End Property

    Public Property vCartonRepeatPara() As String

        Get
            Return m_CartonRepeatPara
        End Get
        Set(ByVal Value As String)
            m_CartonRepeatPara = Value
        End Set

    End Property

    Public Property vBigCartonRepeatStyle() As String
        Get
            Return m_BigCartonRepeatStyle
        End Get
        Set(ByVal Value As String)
            m_BigCartonRepeatStyle = Value
        End Set
    End Property

    Public Property vBigCartonRepeatPara() As String

        Get
            Return m_BigCartonRepeatPara
        End Get
        Set(ByVal Value As String)
            m_BigCartonRepeatPara = Value
        End Set
    ...
    End Property
    '第二层
    Public Property IsOnlineGenCartonID2() As Boolean

        Get
            Return m_IsOnlineGenCartonID2
        End Get
        Set(ByVal Value As Boolean)
            m_IsOnlineGenCartonID2 = Value
        End Set

    End Property
    Public Property PrtPalletCheck() As Boolean
    ...
    Public Property PartPackQty() As String   ''歐翔烽 2007 01 29
    ...
    Public Property IsLinePrintFullCode() As String
        Get
    ...
    Public Property LabelNum() As String
        Get
            Return m_LabelNum
        End Get
        Set(ByVal value As String)
    ...
    Public Property IsPrtSelf() As String
        Get
            Return m_IsPrtSelf
        End Get
        Set(ByVal value As String)
    ...
    Public Property IsLineWeight() As String
        Get
    ...
    Public Property UpLimitWeight() As String
        Get
        ...
        End Set
    End Property
    Public Property LowLimitWeight() As String
        Get
    ...
    Public Property IsPpidLineWeight() As String
        Get
    ...
    Public Property PpidUpLimitWeight() As String
        Get
        ...
        End Set
    End Property
    Public Property PpidLowLimitWeight() As String
        Get
        ...
        End Set
    End Property
    Public Property IsOnlineGenPalletID() As Boolean
    ...
    End Property
    'cq 20170330
    Public Property TTPackQty() As String
        Get
            Return m_EquipmentLifeCheck
        End Get
        Set(ByVal Value As String)
    ...
    End Property
    'add 20190909
    Public Property IsScanN() As String
        Get
            Return m_IsScanN
        End Get
        Set(ByVal value As String)
    ...
    End Property
    'add 20190909
    Public Property ScanNumber() As String
        Get
            Return m_ScanNumber
        End Get
        Set(ByVal value As String)
    ...
    Public Property IsNotCaseSensitive() As String
        Get
        ...
        End Set
    End Property
    Public Property IsEquipMoSet() As String
        Get
            Return m_IsEquipMoSet
        End Get
        Set(ByVal value As String)
            m_IsEquipMoSet = value
        End Set
    End Property
#End Region
