...
#Region "事件"
        ...
        Try
            If (Not String.IsNullOrEmpty(e.Node.Text)) Then
                If (e.Node.Nodes.Count = 0) Then
                    Dim dtBom As DataTable
                    Dim BomQuery As New com.luxshare_ict.plm.WebService1()
                    dtBom = BomQuery.GetBOMData(VbCommClass.VbCommClass.UseId, e.Node.Text)
                    ...
                    Dim dtClassification As DataTable
    ...
    Private Function UnionRcardAndSOP(ByVal PartID As String, ByVal dt As DataTable) As DataTable
        Try
            ...
            Dim dtRCard As DataTable = MainFrame.DbOperateUtils.GetDataTable(sql)
            ...
            Dim dtSOP As DataTable = MainFrame.DbOperateUtils.GetDataTable(sql)
            ...
            If dtRCard.Rows.Count > 0 Then
                ...
                MyDr("Create_name") = MainFrame.DbOperateUtils.GetDataTable("select UserName from m_Users_t where UserID='" & MyDr("Create_id") & "'").Rows(0)(0).ToString()
        ...
        Try
            ...
            If dgvECNList.Columns(e.ColumnIndex).Name = "btnClassification" Then
                ...
                If classification = "流程卡" Then
                    'Dim dtRCard As DataTable = MainFrame.DbOperateUtils.GetDataTable(RCard.FrmRunCardImportStation.GetExportSql(PartID, False, Version))  'GetExportSql(PartID, False, Version)
                    Dim dtRCard As DataTable = MainFrame.DbOperateUtils.GetDataTable(GetExportSql(PartID, False, Version))
...
#End Region
    ...
    Private Function GetPrintListId(ByVal docId As String) As List(Of String)
        ...
        ds = DAL.GetDataSet(o_strSql.ToString)
    ...
    Private Sub BindBom(ByVal dtBom As DataTable, ByVal node As DevComponents.AdvTree.Node)
        ...
        Try
            ...
            For i As Int16 = 0 To dtBom.Rows.Count - 1
                ...
                nodeChild.Tag = dtBom.Rows(i).Item("BomName").ToString
                nodeChild.Text = dtBom.Rows(i).Item("BomNo").ToString
