...
Public Class FrmEquMaintenanceMonth
...
#Region "自定义函数"
    ...
    Private Sub LoadMaintenanceMonth()
        Try
            ...
            o_strSql.Append(" FROM ( SELECT a.Id,a.MaintenanceProject,case when b.Status='O' then '√' else '×' END AS [Status], b.Months as [DD] FROM m_EquMaintenanceType_t a ")
            ...
            o_strSql.Append(" FROM (  SELECT  b.Months ,c.UserName FROM m_EquMaintenanceType_t a INNER JOIN m_AssetMaintenanceMonth_t b on b.MaintenanceProject=a.MaintenanceProject ")
        ...
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmAssetMaintenanceMonth", "LoadMaintenanceMonth", "Equ")
        End Try
    End Sub
    ...
    Private Sub LoadMaintenanceQuarter()
        Try
            ...
            o_strSql.Append("  FROM m_EquMaintenanceType_t a  inner join m_AssetMaintenanceQuarter_t b on b.MaintenanceProject=a.MaintenanceProject  ")
    ...
    Private Sub LoadMaintenanceMonthEdit()
        Try
            ...
            o_strSql.Append(String.Format("  FROM m_EquMaintenanceType_t WHERE AssetName =N'{0}' and IsMpMonth=1   ORDER BY id ASC", Me.txtAssetName.Text.Trim))
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "LoadMaintenanceMonthEdit", "Equ")
        End Try
    End Sub
    ...
    Private Sub LoadMaintenanceQuarterEdit()
        Try
            ...
            Dim dt As New DataTable
            o_strSql.Append("SELECT row_number() OVER(ORDER BY ID) idx,AssetName,MaintenanceProject,0 as IsOk,0 as IsNg,'' as Remark ")
            o_strSql.Append(String.Format("  FROM m_EquMaintenanceType_t WHERE AssetName =N'{0}' and IsMpQuarter=1   ORDER BY id ASC", Me.txtAssetName.Text.Trim))
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "LoadMaintenanceQuarterEdit", "Equ")
        End Try
    End Sub
    ...
    Private Sub LoadMaintenanceMonthRecord(ByVal month As String)
        Try
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "LoadMaintenanceMonthRecord", "Equ")
        End Try
    End Sub
    ...
    Private Sub LoadMaintenanceQuarterRecord(ByVal quarter As String)
        Try
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "LoadMaintenanceQuarterRecord", "Equ")
        End Try
    End Sub
    ...
    Private Function CheckDataQuarterSpec() As Boolean
        ...
        '不允许提前维护季度
        If Val(Me.txtQuarter.Text) > EquManageCommon.GetQuarter() And Val(cbYear.Text) > Date.Now.Year Then
    ...
    Private Function ExistMaintenanceToMonth() As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "ExistMaintenanceToMonth()", "sys")
        End Try
        Return False
    End Function
    ...
    Private Function ExistMaintenanceToMonthSpec() As Boolean
        Try
            Dim strSql As String = Nothing
            Dim iRow As Integer = 0
            strSql = String.Format(" SELECT * FROM m_AssetMaintenanceMonth_t WHERE AssetNo='{0}' AND YEAR = '" & lbYear.Text &
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "ExistMaintenanceToMonthSpec", "Equ")
        End Try
        Return False
    End Function
    ...
    Private Function ExistMaintenanceToQuarter() As Boolean
        Try
            Dim strSql As String = Nothing
            Dim iRow As Integer = 0
            strSql = String.Format("SELECT * FROM m_AssetMaintenanceQuarter_t WHERE AssetNo='{0}' AND  Quarter=cast(datepart(QUARTER,getdate()) as varchar(10))   ", Me.txtAssetNo.Text.Trim)
            iRow = DbOperateUtils.GetRowsCount(strSql)
            If iRow > 0 Then
                Return True
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "ExistMaintenanceToQuarter()", "sys")
        End Try
        Return False
    End Function
    ...
    Private Function ExistMaintenanceToQuarterSpec() As Boolean
        Try
            Dim strSql As String = Nothing
            Dim iRow As Integer = 0
            strSql = String.Format("SELECT * FROM m_AssetMaintenanceQuarter_t WHERE AssetNo='{0}' AND YEAR = '" & lbYear.Text &
    ...
    Private Function SaveDataMonth() As Boolean
        ...
        Try
            ...
            Next
            Dim o_strSql = New System.Text.StringBuilder()

            Dim sql = "select NextMonthKeep from  m_Mould_t  where MouldID='" & Me.txtAssetNo.Text.Trim & "'"
            Dim NextMonthKeep = DbOperateUtils.GetDataTable(sql).Rows(0)(0)
            If IsDBNull(NextMonthKeep) = False Then
                Dim NextMonthKeepTime = Convert.ToDateTime(NextMonthKeep).AddMonths(1).ToString("yyyy-MM-dd")
                o_strSql.AppendLine("update m_Mould_t set NextMonthKeep='" & NextMonthKeepTime & "' where MouldID='" & Me.txtAssetNo.Text.Trim & "'")
                DbOperateUtils.ExecSQL(o_strSql.ToString())

            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "SaveDataMonth()", "sys")
        End Try
    ...
    Private Function SaveDataQuarter() As Boolean
        Try
            ...
            Next
            Dim o_strSql = New System.Text.StringBuilder()
            Dim sql = "select NextSeasonKeep from  m_Mould_t  where MouldID='" & Me.txtAssetNo.Text.Trim & "'"
            Dim NextSeasonKeep = DbOperateUtils.GetDataTable(sql).Rows(0)(0)
            If IsDBNull(NextSeasonKeep) = False Then
                Dim NextSeasonKeepTime = Convert.ToDateTime(NextSeasonKeep).AddMonths(3).ToString("yyyy-MM-dd")
                o_strSql.AppendLine("update m_Mould_t set NextSeasonKeep='" & NextSeasonKeepTime & "' where MouldID='" & Me.txtAssetNo.Text.Trim & "'")
            End If
            DbOperateUtils.ExecSQL(o_strSql.ToString())
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "SaveDataQuarter", "Equ")
        End Try
        Return True
    End Function
    ...
    Private Function SaveDataQuarterSpec() As Boolean
        Try
            ...
            DbOperateUtils.ExecSQL(o_strSql.ToString())
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "SaveDataQuarterSpec", "Equ")
        End Try
        Return True
    End Function
    ...
    Private Sub SaveDataRowToMonth(ByVal row As DataRow)
        Try
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "SaveDataRowToMonth()", "sys")
        End Try
    End Sub
    ...
    Private Sub SaveDataRowToQuarter(ByVal row As DataRow)
        Try
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "SaveDataRowToQuarter", "Equ")
        End Try
    End Sub
    ...
    Private Sub SaveDataRowToQuarterSpec(ByVal row As DataRow)
        Try
            ...
            End If
        Catch ex As Exception
            SysMessageClass.WriteErrLog(ex, "FrmEquMaintenanceMonth", "SaveDataRowToQuarterSpec", "Equ")
        End Try
    End Sub

    'Private Function getMonthByQuarter() As Integer
    '    Dim Month = 0
    '    Dim ram = New Random()
    '    Select Case Convert.ToInt32(txtQuarter.Text)
    '        Case 1
    '            Month = ram.Next(1, 3)
    '        Case 2
    '            Month = ram.Next(4, 6)
...
#End Region
    ...
    Private Sub chkMonth_CheckedChanged(sender As Object, e As EventArgs) Handles chkMonth.CheckedChanged
        For Each dgvr As DataGridViewRow In dgvMaintenanceM.Rows
            dgvr.Cells("Column16").Value = chkMonth.Checked
        Next
    End Sub

    Private Sub ChkQuarters_CheckedChanged(sender As Object, e As EventArgs) Handles ChkQuarters.CheckedChanged
        For Each dgvr As DataGridViewRow In dgvMaintenanceQ.Rows
            dgvr.Cells("DataGridViewCheckBoxColumn1").Value = ChkQuarters.Checked
        Next
    End Sub
