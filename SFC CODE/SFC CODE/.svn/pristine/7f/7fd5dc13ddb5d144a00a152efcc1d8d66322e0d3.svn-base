...
Public Class ScanOption
    ...
    Public Shared IsScanCustProAndQtyI As Boolean = False
    '客户料号条码
    Public Shared CustPartStyle As String = ""
    '装箱数量条码
    Public Shared CartonQtyIStyle As String = ""

    '是否系统打印条码 Add By KyLinQiu 20171016
    Public Shared IsSystemPrintCarton As Boolean = False
    Public Shared IsSystemPrintQRCode As Boolean = False
    Public Shared IsSystemPrintPECarton As Boolean = False
    Public Shared IsSystemPrintPpID As Boolean = False

    '是否扫描固定外箱 Add By KyLinQiu20180315
    Public Shared IsScanFixedCarton As Boolean = False

    Shared _CartonAutoGen As Integer = 0  ''是否自动产生箱号
    Public Shared Property CartonAutoGen() As Boolean
        Get
            Return _CartonAutoGen
        End Get
        Set(ByVal Value As Boolean)
            _CartonAutoGen = Value
        End Set
    End Property
    'Mr Luu Add Scan Product Barcode for Dell Customer  20190917
    Shared _ProductPPID As String
    Public Shared Property ProductPPID() As String
        Get
            Return _ProductPPID
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Shared _PPid_N As Integer = 0  ''是否固定码
    Public Shared Property PPid_N() As Boolean
        Get
            Return _PPid_N
        End Get
        Set(ByVal Value As Boolean)
        ...
        End Set
    End Property
    Shared _MONGQty As Integer
    Public Shared Property MONGQty() As Integer
        Get
            Return _MONGQty
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Shared _MOSetupQty As Integer
    Public Shared Property MOSetupQty() As Integer
        Get
            Return _MOSetupQty
        End Get
        Set(ByVal Value As Integer)
    ...
    Shared _MOScannedQty As Integer
    Public Shared Property MOScannedQty() As Integer
        Get
            Return _MOScannedQty
        End Get
        Set(ByVal Value As Integer)
            _MOScannedQty = Value
        End Set
