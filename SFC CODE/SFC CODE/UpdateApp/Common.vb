...
Public Class Common
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFileTime(ByRef filePath) As Date
        Try
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFileExtension(ByRef filePath) As String
        Try
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function CompareTime(ByVal localTime, ByVal UpTime) As Boolean
        Dim flag As Boolean = False
        Try
            If Not String.IsNullOrEmpty(localTime) And Not String.IsNullOrEmpty(UpTime) Then
                If Date.Parse(localTime) <> Date.Parse(UpTime) Then
                    flag = True
                End If
            End If
        Catch ex As Exception
