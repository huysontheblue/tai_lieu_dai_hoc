...
Public Class LabelHelper
    Public Sub New(ByVal partNumber As String, ByVal number As String, ByVal lot As String, ByVal storage As String, ByVal lineId As String, ByVal mdlineId As String, ByVal coutnumber As String, Optional ByVal copies As Integer = 1)
        Me.PartNumber = partNumber
        Me.Number = number
        Me.Lot = lot
        Me.Storage = storage
        Me.LineId = lineId
        Me.MdLineId = mdlineId
        Me.Copies = copies
    ...
    Private MdLineId As String  '目的线别
    ...
    Public Function PrintLabel(ByVal printer As String, ByVal filePath As String) As Boolean
        ...
        Try
            For index As Integer = 1 To Copies
                ...
                btFormat.SetNamedSubStringValue("MdLineId", MdLineId)
        ...
        Try
            For Each pList As LabelHelper In partList
                For index As Integer = 1 To pList.Copies
                    ...
                    btFormat.SetNamedSubStringValue("MdLineId", pList.MdLineId)
