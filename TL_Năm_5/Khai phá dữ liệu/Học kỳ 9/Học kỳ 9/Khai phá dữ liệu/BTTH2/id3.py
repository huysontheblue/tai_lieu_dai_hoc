...
if __name__ == "__main__":
    ...
    X = df.iloc[:, :-1]
    X1 = pd.DataFrame({'id':[1,2,3,4,5], 'outlook':['rainy','rainy','overcast','sunny','overcast'],
    'temperature':['cool','mild','cool','hot','hot'], 'humidity':['high','normal','normal','high','normal'],
    'wind':['weak','strong','strong','weak','strong']})
    y = df.iloc[:, -1]
